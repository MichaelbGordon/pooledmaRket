...
* `finding_data`. This data set includes information about the original finding that was replicated, including study name and a binary variable where 0 indicates an unsuccessful replication and 1 indicates successful replication. 
...
```{r example, tidy=TRUE, message=FALSE, warning = FALSE}
library(dplyr)
library(tidyr)
library(devtools)
